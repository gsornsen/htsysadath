...
| **Art Binder (a concurrent spine, not on the arc's stated beats)** | 2026-08-12 → 08-29 | 46 unique non-merge binder commits 08-13 → 08-18 on `feat/michi-binder` (0 merged to main in that window); ~20 unique binder/art merges 08-23 → 08-29 [review 2026-09-24: the earlier "~40 merges, 08-12 → 08-18" did not reproduce] | `d93b68c35` 2026-08-13 00:42 "feat(binder): Art Binder foundation — model, dev harness, flag gate"; decision doc `docs/plan/2026-08-12-michi-binder-spade.md` (founder's locked decisions) | `0a6119e7f` 2026-08-23 "merge: feat/michi-binder into feat/tid-store-number → feat/unified"; 08-24 burst of ~14 binder merges; last binder merges 08-29 (`6fe0432e9`, `7a3980154`) | Not superseded by whatnot-scout: it was merged and kept shipping alongside lots and scout for another week [src: `git log --all -i --grep=binder`] |
| **Live-stream auction identify (whatnot-scout)** | 2026-08-18 → ongoing through Sept | ~510+ file-touches in W37 alone | `e04b6433b` 2026-08-18 17:50 "feat(whatnot-scout): MV3 shell + P0 pixel-readback capture (Wave 1)"; Waves 2–3 at 18:27 and 19:00; the decision doc `8eb911a86` "SPADE — sub-2s card identification decision" lands at 22:44, AFTER Waves 1–3 [review 2026-09-24: build-first probe, then the SPADE] | `718238b8` 2026-08-21 "merge: identify hardening stack — confident-wrong 0 on live corpus (9 fixes)"; problem re-opened and re-scoped `docs/plan/2026-09-08-card-identification-problem-brief.md` | The existing (pregrade) identify path was ported to a browser extension watching a live Whatnot stream; the SPADE doc frames the ~2s latency budget as "a gate, not a target" [src: docs/plan/2026-08-18-whatnot-sub2s-identify-spade.md] |
...
2. **"Back to live-stream" and "bulk scans/lots" launched in the same week, whatnot first.**
   ...
   `0f6b04285`]
3. **There was an unlabeled fifth spine.** Art Binder (branch work 2026-08-13 → 08-18, merged
   08-23, merges through 08-29) is not part of the arc's stated beats at all. It is real, dated,
   sourced work, it has its own founder-scoped SPADE (`docs/plan/2026-08-12-michi-binder-spade.md`),
   and it ran concurrently with lots and whatnot-scout rather than before them. [src: `d93b68c35`,
   `0a6119e7f`, `6fe0432e9`; corrected on review 2026-09-24]
...
commit record is: pregrade identify and comps from day one → Art Binder, lots and
live-stream scout all open within a week (08-13, 08-18, 08-19) and run side by side through
late August → comps matures in dated waves keyed to the load lots and scout produced. Several
spines at once, not four acts.
