...
Lane `fix/F2-deck` · Opus 5.5 · 2026-09-24 11:48 PDT. v3 (lane `story/S1-deck-v2`, built on
structure v2 and D17) revised against critique round 2 (`talk/plan/critique2.md`, section F2): old
slide 13 splits into 13 (top-3 halves the gain) and 14 (the bar, live), so every later slide moves
up by one; slide 6 carries the definitions and the cost line; slide 12 says the shipped arm was
found after the kill; slide 19 gives each action a first step and a starter path. D18 still holds:
the crop vote stays, and nothing here claims a single crop beat it. Gerald is protagonist and
narrator. The spoken part is written to be said out loud (60–150 words a slide); stage directions
sit in **Stage** blocks and don't count. This file and the Marp notes in `talk/slides/deck.md` are
kept in sync by hand. There are no placeholders left in either.
...
~30 minutes a day of his time [D16]. One more line is his framing, not a finding: the sentence for
your boss on slide 19.
...
## Slide 13 · Method: measure the bar: top-3 halves the gain
...
## Slide 14 · Method: measure the bar: the bar, live
...
## Slide 16 · Method: hardest shared core first
...
## Slide 17 · Method: persona review gates
...
## Slide 18 · Method: agents first, human verdict
